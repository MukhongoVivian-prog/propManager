...
urlpatterns = [
    ...
    # booking flow urls
    path('booking/<int:booking_id>/reserve/',
         views.reserve_booking, name='reserve_booking'),
    path('booking/<int:booking_id>/checkin/',
         views.checkin_booking, name='checkin_booking'),
    path('booking/<int:booking_id>/success/',
         views.booking_success, name='booking_success'),
    path('booking/<int:booking_id>/payment/',
         views.payment_page, name='payment_page'),
    path('booking/<int:booking_id>/process-payment/',
         views.process_payment, name='process_payment'),
    path('booking/<int:booking_id>/payment-success/',
    ...
    path('landlord/booking/<int:booking_id>/approve/',
         views.landlord_approve_booking, name='landlord_approve_booking'),
