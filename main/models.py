...
class Property(models.Model):
    ...
    date_added = models.DateTimeField(auto_now_add=True) # Automatically sets date when created
    date_updated = models.DateTimeField(auto_now=True)   # Automatically updates date on each save

    class Meta:
        verbose_name_plural = "Properties" # Makes the admin interface show "Properties" instead of "Propertys"
